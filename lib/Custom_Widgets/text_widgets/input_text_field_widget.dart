...
class NumberWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return textFormField(
      ...
      borderRaduis: 10,
      hintStyle:
          style ?? TextStyleConstant.regular14().copyWith(color: ColorConstant.greenColor),
      textStyle: textStyle ?? TextStyleConstant.regular14(),
      controller: controller,
      style: style,
...
class TextFormFieldWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return textFormField(
      ...
      textStyle: textStyle,
      hintStyle:
          hintStyle ?? TextStyleConstant.regular14().copyWith(color: ColorConstant.grey),
      borderColor: borderColor,
      filledColor: filledColor,
    );
  }
...
class TextAreaWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return textFormField(
        ...
        textStyle: TextStyleConstant.semiBold14(),
        filledColor: ColorConstant.barrierBlackColor,
...
class SearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormFieldWidget(
      ...
      borderColor: Colors.transparent,
      filledColor: ColorConstant.lightBlackColor,
...
TextFormField textFormField({
  ...
  return TextFormField(
    ...
    cursorHeight: 20,
    style: textStyle ?? TextStyleConstant.regular14(),
    decoration: InputDecoration(
      ...
      filled: true,
      hintStyle:
          hintStyle ?? TextStyleConstant.semiBold14().copyWith(color: ColorConstant.greyColor),
      hintText: hintText,
      enabled: enabled ?? true,
      suffixIcon: suffixIcon,
      labelText: labelText,
...
TextFormField outlineTextField({
  ...
  return TextFormField(
    ...
    autofocus: autofocus,
    textAlign: textAlign,
    cursorColor: ColorConstant.regularGrey,
    cursorHeight: 20,
    style: textStyle ?? TextStyleConstant.regular14(),
    decoration: InputDecoration(
      ...
      hintText: hintText,
      hintStyle: hintStyle ?? TextStyleConstant.regular14(),
      prefixIcon: prefixIcon,
      suffixIcon: suffixIcon,
      labelText: labelText,
      helperText: helperText,
...
OutlineInputBorder outlineBorderDecoration = const OutlineInputBorder(
  borderSide: BorderSide(color: ColorConstant.darkGreyWhite, width: 1.2),
  borderRadius: BorderRadius.zero,
);
