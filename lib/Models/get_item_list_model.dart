...
class GetItemListModel {
  ...
  factory GetItemListModel.fromJson(Map<String, dynamic> json) =>
      GetItemListModel(
...
class ProductList {
  ...
  factory ProductList.fromJson(Map<String, dynamic> json) => ProductList(
        ...
        itemAddQuantity: json["item_add_quantity"],
        itemAddCartId: json["item_add_cartid"],
      );
